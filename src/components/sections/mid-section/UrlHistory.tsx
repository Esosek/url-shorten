    ...
    <ul className="flex flex-col gap-4 mb-24">
      {urlHistory.map((url, index) => {
        return (
          <li
            key={index}
            className="relative grid grid-cols-1 grid-rows-3 gap-2 text-sm items-center justify-items-start text-neutral-900 bg-white px-4 md:px-6 pt-2 pb-4 text-left shadow-sm rounded-md md:grid-rows-1 md:gap-6 md:grid-cols-[4fr_1fr_auto] md:text-base md:py-4"
          >
            <p
