      ...
      <div className="grid grid-cols-1 justify-items-center items-start justify-center px-6 max-w-5xl mx-auto gap-10 md:grid-cols-[auto_1fr_auto] md:justify-items-start">
        ...
        <div className="grid grid-cols-1 gap-16 text-center md:justify-self-end md:grid-cols-3 md:text-start">
          <ul className="flex flex-col">
            ...
            <li>
              <Link cssClass="text-neutral-300 hover:text-cyan-500">
                Link Shortening
              </Link>
            </li>
            <li>
          ...
          <ul className="flex flex-col">
            <p className="text-neutral-100 mb-4">Resources</p>
            <li>
              <Link cssClass="text-neutral-300 hover:text-cyan-500">Blog</Link>
            </li>
            <li>
              <Link cssClass="text-neutral-300 hover:text-cyan-500">
                Developers
          ...
          <ul className="flex flex-col">
            <p className="text-neutral-100 mb-4">Company</p>
            <li>
              <Link cssClass="text-neutral-300 hover:text-cyan-500">About</Link>
            </li>
            <li>
              <Link cssClass="text-neutral-300 hover:text-cyan-500">
                Our Team
        ...
        <div className="flex gap-6">
          <Link>
            <svg
              ...
              width="24"
              height="24"
              className="fill-neutral-100 group-hover:fill-cyan-500 transition-colors"
            >
